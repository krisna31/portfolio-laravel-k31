        ...
        <div class="flex justify-center items-center gap-4 w-full">
          <div class="flex flex-col justify-center items-center gap-4">
            ...
            <a href="https://github.com/krisna31/sinodes-tailwind" title="Link Project Sinodes Tailwind"
              rel="noopener noreferrer" target="_blank" class="transition-all text-center hover:text-black"><svg
                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="text-center">
                <path
          ...
          <img src="{{ asset('storage/project/1.jpg') }}" alt="First Project" class="w-2/3 h-1/2" />
        </div>
        <div class="flex justify-center items-center gap-4 w-full">
          <div class="flex flex-col justify-center items-center gap-4">
          ...
          <img src="{{ asset('storage/project/2.jpg') }}" alt="First Project" class="w-2/3 h-1/2" />
        </div>
        <div class="flex justify-center items-center gap-4 w-full">
          <div class="flex flex-col justify-center items-center gap-4">
          ...
          <img src="{{ asset('storage/project/3.jpg') }}" alt="First Project" class="w-2/3 h-1/2" />
        </div>
        <div class="flex justify-center items-center gap-4 w-full">
          <div class="flex flex-col justify-center items-center gap-4">
          ...
          <img src="{{ asset('storage/project/4.jpg') }}" alt="First Project" class="w-2/3 h-1/2" />
        </div>
      </div>
    </section>
