                ...
                <form action="{{ route('local.store') }}" class="form-control" method="POST">
                    <div class="p-6 text-gray-900 dark:text-gray-100 flex flex-col items-center">
                        ...
                        <main class="mt-3 pt-16 px-0 font-bold text-black flex flex-col">
                                ...
                                <header
                                    ...
                                    <label class="input-group">
                                        <input name="landing_text" type="text" placeholder="Landing Text"
                                            ...
                                            value="{{ old('landing_text', 'Landing Text') }}" />
                                    </label>
                                    <label class="input-group">
                                        <input name="landing_body" type="text" placeholder="Landing Body"
                                            class="input input-bordered"
                                            value="{{ old('landing_body', 'Landing Body') }}" />
                                    </label>
                                </header>
                            </div>

                            <div
                                class="flex items-center mx-5 sky-tr flex-col rounded-md md:w-1/2 md:ml-4  backdrop-blur-sm">
                                <blockquote class="pt-6 px-6 text-base font-bold md:text-3xl">
                                    <label class="input-group">
                                        <input name="intro_text" type="text" placeholder="Intro Text"
                                            class="input input-bordered"
                                            value="{{ old('intro_text', 'Intro Text') }}" />
                                    </label>
                                    <br />
                                </blockquote>
                                <label class="input-group">
                                    <input name="contact_me_link" type="text" placeholder="Contact Me Link"
                                        class="input input-bordered"
                                        value="{{ old('contact_me_link', 'Contact Me Link') }}" />
                                </label>
                                <div class="bg-slate-500 rounded-sm my-2 flex justify-center items-center mr-auto ml-4">
                                    <label class="input-group">
                                        <input name="contact_me_text" type="text" placeholder="Contact Me"
                                            class="input input-bordered bg-transparent text-center"
                                            value="{{ old('contact_me_text', 'Contact Me') }}" />
                                    </label>
                                </div>
                            </div>

                            <section
                                class="sky-tr backdrop-blur-sm flex items-center m-5 flex-col gap-2 p-5 rounded-md bg-opacity-80 mx-6 md:ml-96">
                                ...
                                <div
                                    ...
                                    <div class="flex justify-center items-center gap-4 w-full">
                                        <div class="flex flex-col justify-center items-center gap-4">
                                            ...
                                            <a href="github.com" title="Link Project Sinodes Tailwind"
                                        ...
                                        <img src="{{ asset('assets/1.png') }}" alt="First Project"
                                            class="w-2/3 h-1/2" />
                                    </div>
                                </div>
                            </section>
                            ...
                            <div
                                class="flex items-center mx-5 sky-tr flex-col md:mx-52 lg:mx-80 rounded-md backdrop-blur-sm">
                                <blockquote class="p-6 text-base font-bold lg:text-xl">
                                    <p>
                                        <label class="input-group">
                                            <input name="quote_text" type="text" placeholder="Qoute Text"
                                                class="input input-bordered"
                                                value="{{ old('quote_text', 'Quote Text') }}" />
                                        </label>
                                        <br />
                                        <br />
                                        ...
                                        <label class="input-group">
                                            <input name="quote_name" type="text" placeholder="Quote Name"
                                                class="input input-bordered"
                                                value="{{ old('quote_name', '-Quote Name') }}" />
                                        </label>
                                    </p>
                                </blockquote>
                            </div>
                            ...
                            <div id="socmed"
                                class="flex items-center mx-5 sky-tr flex-col md:mx-52 lg:mx-80 rounded-md scroll-mt-36 backdrop-blur-sm">
                                <blockquote class="p-6 text-base font-bold">
                                    <h2 class="text-2xl mb-3 lg:text-3xl">

                                        <label class="input-group">
                                            <input name="social_text" type="text" placeholder="Social Text"
                                                class="input input-bordered"
                                                value="{{ old('social_text', 'Social Text') }}" />
                                        </label>
                                    </h2>
                                    <div class="flex flex-row justify-between">
                                        <a href="https://www.facebook.com/profile.php?id=100006248929202"
                                            ...
                                            <svg class="w-5 h-4 md:w-7 md:h-7 lg:w-9 lg:h-9 text-blue-600"
                                        ...
                                        <a href="https://github.com/krisna31" title="Link Github Krisna"
                                            class="text-gray-500 hover:text-gray-900 dark:hover:text-white"
                                            target="_blank" rel="noopener noreferrer">
                                            <svg class="w-5 h-4 md:w-7 md:h-7 lg:w-9 lg:h-9 text-black"
                                                fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                                <path fillRule="evenodd"
                                        ...
                                        <a href="https://www.instagram.com/krisna_putra31/"
                                            title="Link Instagram Krisna"
                                            class="text-gray-500 hover:text-gray-900 dark:hover:text-white"
                                            target="_blank" rel="noopener noreferrer">
                                            <svg class="w-5 h-4 md:w-7 md:h-7 lg:w-9 lg:h-9 text-pink-600"
                                                fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                                <path fillRule="evenodd"
                            ...
                            <footer class="py-3 px-0 font-bold bg-slate-500 bg-opacity-40 backdrop-blur-sm">
                                <label class="input-group flex justify-center">
                                    <input name="footer" type="text" placeholder="Footer"
                                        class="input input-bordered w-11/12 text-center bg-transparent"
                                        value="{{ old('footer', 'Footer') }}" />
                                </label>
                            </footer>
                        </main>
