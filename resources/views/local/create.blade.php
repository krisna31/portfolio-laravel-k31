                    ...
                    <form action="{{ route('local.store') }}" class="form-control" method="POST">
                        ...
                        <label class="input-group">
                            ...
                            <input name="landing_text" type="text" placeholder="Landing Text"
                                class="input input-bordered" value="{{ old('landing_text', 'Landing Text') }}" />
                        </label>
                        <label class="label">
                        ...
                        <label class="input-group">
                            ...
                            <input name="landing_body" type="text" placeholder="Landing Body"
                                class="input input-bordered" value="{{ old('landing_body', 'Landing Body') }}" />
                        </label>
                        <label class="label">
                        ...
                        <label class="input-group">
                            ...
                            <input name="intro_text" type="text" placeholder="Intro Text"
                                class="input input-bordered" value="{{ old('intro_text', 'Intro Text') }}" />
                        </label>
                        <label class="label">
                        ...
                        <label class="input-group">
                            ...
                            <input name="contact_me_text" type="text" placeholder="Contact Me Text"
                                class="input input-bordered" value="{{ old('contact_me_text', 'Contact Me Text') }}" />
                        </label>
                        <label class="label">
                        ...
                        <label class="input-group">
                            ...
                            <input name="contact_me_link" type="text" placeholder="Contact Me Link"
                                class="input input-bordered" value="{{ old('contact_me_link', 'Contact Me Link') }}" />
                        </label>
                        <label class="label">
                        ...
                        <label class="input-group">
                            ...
                            <input name="quote_text" type="text" placeholder="Qoute Text"
                                class="input input-bordered" value="{{ old('quote_text', 'Quote Text') }}" />
                        </label>
                        <label class="label">
                        ...
                        <label class="input-group">
                            ...
                            <input name="quote_name" type="text" placeholder="Quote Name"
                                class="input input-bordered" value="{{ old('quote_name', 'Quote Name') }}" />
                        </label>
                        <label class="label">
                        ...
                        <label class="input-group">
                            ...
                            <input name="social_text" type="text" placeholder="Social Text"
                                class="input input-bordered" value="{{ old('social_text', 'Social Text') }}" />
                        </label>
                        <label class="label">
