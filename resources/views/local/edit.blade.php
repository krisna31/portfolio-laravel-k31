                                ...
                                <header
                                    ...
                                    <label class="input-group">
                                        <input name="landing_text" type="text" placeholder="Landing Text"
                                            ...
                                            value="{{ old('landing_text', $local->landing_text) }}" />
                                    </label>
                                    <label class="input-group">
                                        <input name="landing_body" type="text" placeholder="Landing Body"
                                            class="input input-bordered"
                                            value="{{ old('landing_body', $local->landing_body) }}" />
                                    </label>
                                </header>
                            </div>
                                ...
                                <blockquote class="pt-6 px-6 text-base font-bold md:text-3xl">
                                    <label class="input-group">
                                        <input name="intro_text" type="text" placeholder="Intro Text"
                                            class="input input-bordered"
                                            value="{{ old('intro_text', $local->intro_text) }}" />
                                    </label>
                                    <br />
                                </blockquote>
                                <label class="input-group">
                                    ...
                                    <p>
                                        <label class="input-group">
                                            <input name="quote_text" type="text" placeholder="Qoute Text"
                                                class="input input-bordered"
                                                value="{{ old('quote_text', $local->quote_text) }}" />
                                        </label>
                                        <br />
                                        <br />
                                        ...
                                        <label class="input-group">
                                            <input name="quote_name" type="text" placeholder="Quote Name"
                                                class="input input-bordered"
                                                value="{{ old('quote_name', $local->quote_name) }}" />
                                        </label>
                                    </p>
                                </blockquote>
                            </div>
                                    ...
                                    <h2 class="text-2xl mb-3 lg:text-3xl">
                                        ...
                                        <label class="input-group">
                                            <input name="social_text" type="text" placeholder="Social Text"
                                                class="input input-bordered"
                                                value="{{ old('social_text', $local->social_text) }}" />
                                        </label>
                                    </h2>
