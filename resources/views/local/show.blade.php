    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-blue-200 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <main class="mt-3 pt-16 px-0 font-bold text-black flex gap-14 flex-col">
                    ...
                    <div class="flex items-center mx-5 sky-tr flex-col rounded-md md:w-1/2 md:ml-4  backdrop-blur-sm">
                        <blockquote class="pt-6 px-6 text-base font-bold md:text-3xl">
                            <p>{{ $local->intro_text }}</p>
                            <br />
                        </blockquote>
                    ...
                    <section
                        ...
                        <div
                            ...
                            <div class="flex justify-center items-center gap-4 w-full">
                                ...
                                <img src="{{ asset('storage/project/'.$project->image) }}" alt="First Project"
                                    class="w-2/3 h-1/2" />
                            </div>
                            @endforeach
                        </div>
                    ...
                    <div id="socmed"
                        ...
                        <blockquote class="p-6 text-base font-bold">
                            <h2 class="text-2xl mb-3 lg:text-3xl">{{ $local->social_text }}</h2>
