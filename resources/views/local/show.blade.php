        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <main class="w-screen text-slate-300 z-50 absolute mt-3 pt-16 px-0 font-bold">
                    ...
                    <div
                        class="flex items-center mx-5 my-48 sky-tr flex-col rounded-md md:w-1/2 md:ml-4 md:my-96 backdrop-blur-sm">
                    ...
                    <section
                        ...
                        <p class="leading-7 my-3 text-base md:text-xl">
                            Hello, I'm Jelvin Krisna Putra i was born at Palembang city in 2003, my interest with coding
                            and
                            technolog started at young age, and has become my life-long love. On this website you will
                            discover some
                            of my simple projects that
                            created with my main languange Javascript, after year i was learn about basic of html, css,
                            and
                            Javascript i then step further to learn React, SQL, and many other technology. Until now i
                            have many
                            skills which are Html, Css, Js,
                            Java, Git, Github for framework i can React, Tailwind, Bootstrap, For the backend i
                            understand Firebase.
                        </p>
                    </section>

                    <section
                        class="sky-tr backdrop-blur-sm flex flex-col m-5 p-5 rounded-md shadow-md md:my-96 container mx-auto">
                        ...
                        <div
                            ...
                            <div class="flex justify-center items-center gap-4 w-full">
                                <div class="flex flex-col justify-center items-center gap-4">
                                    <p class="text-center">Simple Notes Management (CRUD App, React, Typescript,
                                        Tailwind, Firebase)
                                    </p>
                                    <a href="https://github.com/krisna31/sinodes-tailwind"
                                        title="Link Project Sinodes Tailwind" rel="noopener noreferrer" target="_blank"
                                ...
                                <img src="assets/1.png" alt="First Project" class="w-2/3 h-1/2" />
                            </div>
                            <div class="flex justify-center items-center gap-4 w-full">
                                <div class="flex flex-col justify-center items-center gap-4">
                                    <p class="text-center">Website That Use Space-x API</p>
                                    <a href="https://github.com/krisna31/space-x-api"
                                        title="Link Project Web With Space-x API" rel="noopener noreferrer"
                                        target="_blank" class="transition-all text-center hover:text-black"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" class="text-center">
                                            <path
                                                d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
                                ...
                                <img src="assets/2.jpg" alt="First Project" class="w-2/3 h-1/2" />
                            </div>
                            <div class="flex justify-center items-center gap-4 w-full">
                                <div class="flex flex-col justify-center items-center gap-4">
                                    <p class="text-center">Website Pengenalan Himif (Fullscreen JS)</p>
                                    <a href="https://github.com/krisna31/PengenalanHimif"
                                        title="Link Project Pengenalan Himif" rel="noopener noreferrer" target="_blank"
                                        class="transition-all text-center hover:text-black"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" class="text-center">
                                            <path
                                ...
                                <img src="assets/3.jpg" alt="First Project" class="w-2/3 h-1/2" />
                            </div>
                            <div class="flex justify-center items-center gap-4 w-full">
                                <div class="flex flex-col justify-center items-center gap-4">
                                    <p class="text-center">Website Landing Page With Bootstrap</p>
                                    <a href="https://github.com/krisna31/Landing-profile"
                                        title="Link Project Landing Profile" rel="noopener noreferrer" target="_blank"
                                        class="transition-all text-center hover:text-black"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" class="text-center">
                                            <path
                                ...
                                <img src="assets/4.jpg" alt="First Project" class="w-2/3 h-1/2" />
                            </div>
                        </div>
                    </section>
                    ...
                    <div id="socmed"
                        ...
                        <blockquote class="p-6 text-base font-bold">
                            ...
                            <div class="flex flex-row justify-between">
                                <a href="https://www.facebook.com/profile.php?id=100006248929202"
                                    title="Link Facebook Krisna"
                                ...
                                <a href="https://www.linkedin.com/in/jelvin-krisna-putra-0b8605218/"
                                    title="Link Linkedin Krisna"
                                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white" target="_blank"
                                    rel="noopener noreferrer">
